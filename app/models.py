...
class IpAsset(db.Model):
    ...
    tags = db.Column(db.String(255), default=None)
    ...
    license_period = db.Column(db.String(100), default=None)
    ...
    trademark_info = db.Column(db.Text, default=None)
    contact_email = db.Column(db.String(100), default=None)
    value_level = db.Column(db.Enum('S', 'A', 'B', 'C'), default=None)
    current_revenue = db.Column(db.Numeric(12, 2), default=0.00)
...
class Contract(db.Model):
    ...
    partner_brand = db.Column(db.String(255), default=None)
    region = db.Column(db.String(255), default=None)
    media = db.Column(db.String(255), default=None)
    license_method = db.Column(db.String(255), default=None)
    license_category = db.Column(db.String(255), default=None)
    ...
    case_image_url = db.Column(db.String(255), default=None)
    pdf_url = db.Column(db.String(255), default=None)
